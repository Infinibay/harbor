          ...
          {open
            ? actions.map((a, i) => (
                <motion.button
                  ...
                  aria-label={a.label}
                  className="group relative w-10 h-10 rounded-full border border-[color:var(--harbor-border-default)] bg-[var(--harbor-surface-panel-muted)] text-[rgb(var(--harbor-text-muted))] hover:bg-[var(--harbor-state-hover)] hover:text-[rgb(var(--harbor-text))] shadow-lg grid place-items-center outline-none focus-visible:shadow-[var(--harbor-focus-shadow)]"
                >
                  {a.icon}
                  <span
                    className={cn(
                      "absolute whitespace-nowrap px-2 py-0.5 rounded border border-[color:var(--harbor-border-default)] bg-[var(--harbor-surface-panel)] text-xs text-[rgb(var(--harbor-text))] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none",
