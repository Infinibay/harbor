...
export const en: HarborLocale = {
  ...
  messages: {
    ...
    "harbor.codeeditor.find": "Find",
    "harbor.codeeditor.replace": "Replace",
    "harbor.codeeditor.findPlaceholder": "Find…",
    "harbor.codeeditor.replacePlaceholder": "Replace with…",
    "harbor.codeeditor.searchLabel": "Search",
    "harbor.codeeditor.replaceLabel": "Replace with",
    "harbor.codeeditor.next": "Next match",
    "harbor.codeeditor.prev": "Previous match",
    "harbor.codeeditor.replaceOne": "Replace",
    "harbor.codeeditor.replaceAll": "All",
    "harbor.codeeditor.caseSensitive": "Case sensitive",
    "harbor.codeeditor.wholeWord": "Whole word",
    "harbor.codeeditor.regex": "Regex",
    "harbor.codeeditor.noMatches": "No results",
    "harbor.codeeditor.matchesCount":
      "{current} of {total, plural, one {# match} other {# matches}}",
    "harbor.codeeditor.regionLabel": "Find and replace",
    "harbor.codeeditor.close": "Close",
    "harbor.codeeditor.diagnosticError": "Error",
    "harbor.codeeditor.diagnosticWarning": "Warning",
    "harbor.codeeditor.diagnosticInfo": "Info",
    "harbor.codeeditor.diagnosticHint": "Hint",
