...
export const en: HarborLocale = {
  ...
  messages: {
    ...
    "harbor.datatable.density.label": "Density",
    "harbor.datatable.density.compact": "Compact",
    "harbor.datatable.density.comfortable": "Comfortable",
    "harbor.datatable.density.spacious": "Spacious",
    "harbor.datatable.export.title": "Export",
    "harbor.datatable.export.csv": "Export as CSV",
    "harbor.datatable.export.tsv": "Export as TSV",
    "harbor.datatable.export.json": "Export as JSON",
    "harbor.datatable.rowActions": "Row actions",
